...
function CreateOrder() {
  ...
  const priorityPrice = withPriority ? 25 : 0;
    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 md:flex-row md:items-center">
          ...
          <span className=" absolute right-[0px] top-[3px] z-50 ">
        ...
        <div className="mb-12 flex items-center gap-5">
          <input
            className="m-5 h-6 w-6 accent-emerald-300 focus:outline-none focus:ring focus:ring-emerald-400 focus:ring-offset-2"
            type="checkbox"
            name="priority"
            id="priority"
            value={withPriority}
        ...
        <div>
          ...
          <Button disabled={isSubmitting || isLoadingAddress} type="primary">
            {isSubmitting
              ? 'Placing Order...'
              : `Order Now from paying ${formatCurrency(totalPrice)}`}
          </Button>
        </div>
      </Form>
    </div>
